...
(function($){
	...
	app.masVendidos = function(){
		var productos = [
			...
			{
				id : 4,
				name : 'Platanos Grandes',
				img : 'assets/img/imgplatano.png',
				price : 80.00,
				desc : '......',
				stock : 4
			},
